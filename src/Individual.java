...
public class Individual {
    ...
    public ArrayList<Color> getMainColors(){
    ...
    public ArrayList<Integer> getColorApparition() {
    ...
    public ArrayList<Integer> getDifferentFromZero(ArrayList<Integer> colorApparition){
